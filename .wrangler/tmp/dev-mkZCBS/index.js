...
// .wrangler/tmp/bundle-IA8gJc/checked-fetch.js
...
// .wrangler/tmp/bundle-IA8gJc/strip-cf-connecting-ip-header.js
...
var CardSchema = z.object({
  ...
  url: z.string().url(),
  status: z.enum(["APPLIED", "OA", "INTERVIEW", "OFFER"])
});
var app = new Hono2();
app.use("*", cors());
  ...
  for (const key of list.keys) {
    ...
    if (value) {
      try {
        ...
        console.error(`Failed to parse card from KV: ${key.name}`, e);
      }
    }
  }
  return c.json(cards);
...
// .wrangler/tmp/bundle-IA8gJc/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-IA8gJc/middleware-loader.entry.ts
